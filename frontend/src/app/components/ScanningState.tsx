  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 glass-card rounded-2xl">
      <div className="relative w-32 h-32 mb-8">
        ...
        ></div>
        <div
          className="absolute inset-4 rounded-full border-b-2 border-cyan-500 animate-spin"
      ...
      <p className="text-slate-500 dark:text-gray-600 text-sm mt-4">
        Running mobile + desktop scans via Google PageSpeed Insights API
      </p>
    </div>
  );
}
