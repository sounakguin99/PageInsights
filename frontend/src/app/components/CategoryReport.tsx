...
export default function CategoryReport({
  ...
  const failingAudits = categoryAudits.filter(
    (a: any) =>
      a.score !== null &&
      a.score < 1 &&
  ...
  const manualAudits = categoryAudits.filter(
    (a: any) => a.score_display_mode === "manual",
  );
  ...
  const notApplicable = categoryAudits.filter(
    (a: any) =>
      a.group_type === "not-applicable" ||
      a.score_display_mode === "notApplicable",
  );
      ...
      <div className="glass-card p-6 border border-slate-200 dark:border-white/10">
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1">
            ...
            {description && (
              <p
                className="text-slate-500 dark:text-gray-500 text-sm mt-1"
